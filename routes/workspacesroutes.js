...
import { createProject, createSubItem, createTableProject, detailTableProject, getAllProject, getAllSubItemByTable, getAllTableByProject } from "../controllers/workspacescontroller.js";
...
const storage = multer.diskStorage({
  ...
  const multipleUpload = uploads.fields([{name : 'contenttext',maxCount:1},{name:'contentposting',maxCount:1},{name:'postingcaption',maxCount:1}])
...
router.get("/all-sub-item/:id",uploads.none(), verifyToken, getAllSubItemByTable);
